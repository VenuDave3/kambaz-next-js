...
export default function Lab2() {
  return (
    ...
    <div id="wd-lab2">
      ...
      <p className="wd-class-selector">
        Instead of using IDs to refer to elements, you can use an element is CLASS attribute
      </p>
  ...
  {/* 
    ...
    .wd-selector-4 is a direct child of .wd-selector-3, descendant of .wd-selector-2, and descendant of .wd-selector-1
  */}
